...
sidebar:
  # Nombre
  label: 8.4 Notas sobre la rima
  # Orden (Número más bajo aparece más arriba)
  order: 105
---
## 8.4. Notas sobre la rima

### 8.4.1 Determinación de la rima
...
En cambio, si los dos núcleos tónicos (relieve 3) del final del verso son iguales y los dos núcleos átonos del final del verso son iguale pero las consonantes no coinciden, se trata de rima asonante o parcial.
	...
	(se omite el símbolo del acento porque todos los segmentos en evaluación de rima se inician con una vocal tónica)
