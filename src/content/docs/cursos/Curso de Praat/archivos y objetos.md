...
Si usamos Praat para grabar un audio, nos aparecerá un objeto nuevo al que le podemos dar un nombre. Si no lo almacenamos en el disco duro, no será un archivo disponible.
